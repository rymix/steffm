...
// const DEBUGMODE = globalThis.location.toString().indexOf('VANTAWAVESDEBUG') !== -1

const win = typeof globalThis == 'object'
let THREE = (win && globalThis.THREE) || {}
if (win && !globalThis.VANTAWAVES) globalThis.VANTAWAVES = {}
const VANTAWAVES = (win && globalThis.VANTAWAVES) || {}
VANTAWAVES.register = (name, Effect) => {
  return VANTAWAVES[name] = (opts) => new Effect(opts)
}
VANTAWAVES.version = '0.5.24'
...
const error = function() {
  Array.prototype.unshift.call(arguments, '[VANTAWAVES]')
  return console.error.apply(this, arguments)
}

VANTAWAVES.VantaBase = class VantaBase {
  constructor(userOptions = {}) {
    if (!win) return false
    VANTAWAVES.current = this
    ...
    try {
      ...
      if (!this.options.canvas) {
          ...
          if (this.options.backgroundColor) {
            console.log('[VANTAWAVES] Falling back to backgroundColor')
  ...
  initThree() {
    if (!THREE.WebGLRenderer) {
      console.warn("[VANTAWAVES] No THREE defined on globalThis")
      return
    }
    // Set renderer
  ...
  destroy() {
    ...
    if (VANTAWAVES.current === this) {
      VANTAWAVES.current = null
    }
  }
}

/* harmony default export */ const _base = (VANTAWAVES.VantaBase);
;// CONCATENATED MODULE: ./src/vanta.waves.js



let vanta_waves_THREE = (typeof globalThis == 'object' && globalThis.THREE)
...
Waves.initClass()
/* harmony default export */ const vanta_waves = (VANTAWAVES.register('WAVES', Waves));
