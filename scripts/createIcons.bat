...
FOR %%X in (*.ico) DO (
    ...
    C:\ImageMagick\magick.exe "%%X[6]" -background none -compress lossless -strip -quality 100 "..\24x24\%%~nX.png"
    ...
    cwebp -lossless -m 6 -z 9 -q 100 -alpha_q 100 -sharp_yuv -mt -alpha_filter best -v "..\24x24\%%~nX.png" -o "..\24x24\%%~nX.webp"
...
FOR /D %%X in (*) DO (
    ...
    IF NOT EXIST "%%X\24x24.png" (
        C:\ImageMagick\magick.exe "%%X\max.png" -compress lossless -scale 24x24 -strip -quality 100 "..\24x24\%%~nX.png"
        cwebp -lossless -m 6 -z 9 -q 100 -alpha_q 100 -sharp_yuv -resize 24 24 -mt -alpha_filter best -v "%%X\max.png" -o "..\24x24\%%~nX.webp"
    ) ELSE (
        COPY "%%X\24x24.png" "..\24x24\%%~nX.png"
        cwebp -lossless -m 6 -z 9 -q 100 -alpha_q 100 -sharp_yuv -mt -alpha_filter best -v "..\24x24\%%~nX.png" -o "..\24x24\%%~nX.webp"
    )
